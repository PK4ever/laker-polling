...
<html lang="en" ng-app="mainApp"  ng-controller="AppCtrl">
  <head>
    ...
    <meta property="description" content="Build Your Lists. Learn Something New. Build public & private nested lists of text, links, & images. Collaborate with others to build large lists.">
    <base href="/">
    <meta name="keywords" content="Lists, learn to code, find a job, private lists, create lists, todo lists, to-do lists."/>
    ...
    <meta name="google-signin-client_id" content="190294600455-f9fqaumoifl8a8ud3qsbsg9n5fqblkpe.apps.googleusercontent.com">
    ...
    <meta property="og:image:type" content="${resource(dir:'clienview-source:http://localhost:8080/logintapp', file:'img/logo.png')}">
    <meta property="og:image:width" content="1500">
    <meta property="og:image:height" content="1500">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Laker Polling">
    ...
    <style>
      ...
      navbar-nav>li>a:hover {"imag/png"
  ...
  <body>
    <div class="site-main surface-container">
          ...
          <div class="navbar-header" style="min-height: 60px">
            <div class="navbar-brand">
              <a class="nav-link" ng-click="navigateToPublicLists()">
                <img class="nav-link" src="img/logo.png" style="width:32px; height:32px; position: fixed">
                <span class="bold-title text-m" style="margin-left: 36px; font-size: 28px">Laker Polling</span>
              </a>
            </div>
            <a id="nav-mobile-toggle" class="clean-text" style="float: right;margin: 20px 30px 20px 20px;">&#9776;</a>
          </div>
              ...
              <li id="nav-link-user-dropdown-menu">
                  <div id="nav-current-user-container" style="display:none; top: -10px; position: relative;">
                    <div class="dropdown" style="position: relative; display: block; padding: 10px 15px;">
                      <button id="nav-current-user-dropdown" class="dropdown-toggle" type="button" id="menu1" data-toggle="dropdown" style="background:white; color: rgba(0,0,0,.44); border:none; border-radius: 100%">
                        <img id="nav-current-user-image" style="width:32px; height:32px; border-radius: 100; position:relative; bottom:5px; display:none" src=""/>
                      </button>
                      <ul class="dropdown-menu clean-container" style="padding:15px 0 15px 0; left: -200px;" role="menu" aria-labelledby="menu1">
                        ...
                        onclick="document.getElementById('nav-current-user-username').click()">
                          <a id="nav-current-user-username" role="menuitem" tabindex="-1" ng-click="navigateToCurrentUserLists()" class="nav-link" style="padding-left: 0px;">Username</a>
                        </li>
                        <li role="presentation" >
                          <a id="nav-current-user-email" role="menuitem" tabindex="-1" ng-click="navigateToCurrentUserLists()" class="nav-link">Email</a>
                        </li>
                        <li role="presentation" class="divider"></li>
                        <li role="presentation" ><a id="nav-current-user-email" role="menuitem" tabindex="-1" href="/logout" class="clean-text">Logout</a></li>
                      </ul>
                    </div>
                  </div>
              </li>
      ...
      <div id="footer" class="container" style="margin-bottom:20px">
        <div class="row clean-text" style="padding-top:15px;padding-right:0;padding-bottom:0;padding-left:0;margin-top:50px;color:#b3b3b1;font-size:12px;text-align:center;">
      ...
      %{--<script src="/grails-app/assets/clientapp/js/libs/socket-io/socket.io-1.4.5.js"></script>--}%
      <script src="${resource(dir:'clientapp', file:'js/libs/socket-io/socket.io-1.4.5.js')}"></script>
      ...
      %{--<script src="/grails-app/assets/clientapp/js/libs/angular-socket-io/socket.js"></script>--}%
      <script src="${resource(dir:'clientapp', file:'js/libs/angular-socket-io/socket.js')}"></script>
      ...
      %{--<script src="/grails-app/assets/clientapp/js/app/controllers/forum.js"></script>--}%
      ...
      <script src="${resource(dir:'clientapp', file:'js/app/controllers/forum.js')}"></script>
